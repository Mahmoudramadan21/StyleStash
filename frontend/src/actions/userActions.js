...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`http://localhost:8000/api/users/profile/update/`,
        user,
        config);
...
export const deleteUser = (id) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.delete(`http://localhost:8000/api/users/delete/${id}/`,
        config)
...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`http://localhost:8000/api/users/update/${user.id}/`,
        user,
        config)
