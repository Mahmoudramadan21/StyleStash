    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptrion', models.TextField(blank=True, null=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='Images/')),
                ('categoryOfProduct', models.CharField(blank=True, max_length=100, null=True)),
                ('typeOfProduct', models.CharField(blank=True, max_length=100, null=True)),
                ('sizeOfProduct', models.CharField(blank=True, max_length=100, null=True)),
                ('colorOfProduct', models.CharField(blank=True, max_length=100, null=True)),
